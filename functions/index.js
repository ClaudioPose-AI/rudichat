...
console.log('Antes do Exports')

console.log('Test')

exports.saveLastMessage = functions.firestore.document('/chat/{chatId}/messages/{messageId}').onCreate((change, context) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        chatRef.onSnapshot(snapChat => {
            ...
            let messageRef = chatRef.collection('messages').doc(messageId).onSnapshot(snapMessage => {
                ...
                // Converte objeto de chave / valor para Array
